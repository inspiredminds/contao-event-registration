...
$GLOBALS['TL_LANG']['tl_event_registration']['reg_legend'] = 'Event registration';
$GLOBALS['TL_LANG']['tl_event_registration']['uuid'] = ['UUID', ''];
$GLOBALS['TL_LANG']['tl_event_registration']['form'] = ['Form', ''];
$GLOBALS['TL_LANG']['tl_event_registration']['member'] = ['Member', ''];
