...
$GLOBALS['TL_LANG']['tl_calendar']['reg_cancel_page'] = ['Redirect page for cancelaltion', 'The target page where the event registration cancellation module is integrated. If no page is defined, the redirect page of the calendar is used.'];
